...
;(function($){$.fn.copyOnClick=function(txt){return this.each(function(){var $$=$(this);if($.browser.msie){$$.mousedown(function(e){window.clipboardData.setData('Text',typeof txt=='function'?txt(e):txt);});}else{var clip=$$.data('clip');if(typeof clip=='undefined'){clip=new ZeroClipboard.Client();$$.data('clip',clip);}
...
$.each(['mouseDown','mouseOver','mouseOut','mouseUp'],function(i,el){clip.addEventListener(el,function(client){$$.trigger(el.toLowerCase(),client);});});}});};var base=$('script[src*=jquery.copyonclick]').attr('src').replace(/jquery\.copyonclick(\.min)?\.js/,'');ZeroClipboard.setMoviePath(base+'ZeroClipboard.swf');})(jQuery);