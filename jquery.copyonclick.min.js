...
;(function($){$.fn.copyOnClick=function(txt){return this.each(function(){var $$=$(this);if($.browser.msie){$$.mousedown(function(e){window.clipboardData.setData('Text',typeof txt=='function'?txt(e):txt);});}else{var clip=$$.data('clip');if(clip==null){clip=new ZeroClipboard.Client();$$.data('clip',clip);}
